...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'upload_item')
        ...
        FFRoute(
          name: 'zoeLogin',
          path: '/zoeLogin',
          builder: (context, params) => const ZoeLoginWidget(),
        ),
        FFRoute(
          name: 'sellerProfile',
          path: '/sellerProfile',
          asyncParams: {
            'sellerInfo': getDoc(['users'], UsersRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          asyncParams: {
            'itemDoc': getDoc(['items'], ItemsRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'chat_2_main_1')
              : const Chat2Main1Widget(),
        ),
        FFRoute(
