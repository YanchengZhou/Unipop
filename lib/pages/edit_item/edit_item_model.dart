...
class EditItemModel extends FlutterFlowModel<EditItemWidget> {
  ...
  FormFieldController<List<String>>? availabilityValueController;
  String? get availabilityValue =>
      availabilityValueController?.value?.firstOrNull;
  set availabilityValue(String? val) =>
      availabilityValueController?.value = val != null ? [val] : [];
