                                  ...
                                  children: [
                                    ...
                                    FlutterFlowChoiceChips(
                                      ...
                                      unselectedChipStyle: ChipStyle(
                                        backgroundColor: const Color(0xFFCDC6C6),
                                        textStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily:
                                      ...
                                      multiselect: false,
                                      initialized:
                                          _model.availabilityValue != null,
                                      alignment: WrapAlignment.start,
                                      controller:
                                          _model.availabilityValueController ??=
                                    ...
                                    FlutterFlowChoiceChips(
                                      ...
                                      rowSpacing: 8.0,
                                      multiselect: false,
                                      initialized: _model.categoryValue != null,
                                      alignment: WrapAlignment.start,
                                      controller:
                                    ...
                                    FlutterFlowChoiceChips(
                                      ...
                                      onChanged: (val) => setState(() => _model
                                          .conditionValue = val?.firstOrNull),
                                      selectedChipStyle: ChipStyle(
                                        backgroundColor: const Color(0xFFFFB8BA),
                                        textStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                          ...
                          if (_model.uploadedFileUrls.isNotEmpty) {
                            await widget.item!.reference.update({
                              ...createItemsRecordData(
                                ...
                                type: _model.categoryValue,
                                availability:
                                    _model.availabilityValue == 'Available'
                                        ? true
                                        : false,
